          ...
          <div className="space-y-6 stagger-animation">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg card-hover glass-effect">
              <div className="flex items-center mb-4">
                <GraduationCap className="text-blue-600 mr-3 float-animation" size={24} />
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg card-hover glass-effect">
              <div className="flex items-center mb-4">
                <MapPin className="text-blue-600 mr-3 float-animation" size={24} />
          ...
          <div className="space-y-6 stagger-animation">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg card-hover glass-effect">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <Code className="text-blue-600 mr-3 float-animation" size={24} />
              ...
              <div className="flex flex-wrap gap-2">
                {personalData.skills.languages.map((skill: string, index: number) => (
                  <span
                    key={index}
                    className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full text-sm font-medium skill-tag-enhanced"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg card-hover glass-effect">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <Server className="text-blue-600 mr-3 float-animation" size={24} />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {personalData.skills.frameworks.map((skill: string, index: number) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-sm font-medium skill-tag-enhanced"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {personalData.skills.tools.map((skill: string, index: number) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-full text-sm font-medium skill-tag-enhanced"
                      >
                        {skill}
                      </span>
                    ))}
