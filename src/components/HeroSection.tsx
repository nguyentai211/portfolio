    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-12 animate-fadeInUp">
          ...
          <ParallaxContainer intensity={0.05} className="relative mb-8 animate-slideInRight">
        ...
        {/* Social icons */}
        <ParallaxContainer intensity={0.03} className="flex justify-center space-x-6 animate-fadeInUp stagger-5">
          {[
